...
function updateContainer(container, newTime) {
    ...
    if (((_a = first.lastElementChild) === null || _a === void 0 ? void 0 : _a.textContent) !== time[0]) {
        updateNumber(first, time[0]);
    }
    const last = container.lastElementChild;
    if (((_b = last.lastElementChild) === null || _b === void 0 ? void 0 : _b.textContent) !== time[1]) {
        updateNumber(last, time[1]);
    }
}
function updateNumber(element, number) {
    var _a;
    const second = (_a = element.lastElementChild) === null || _a === void 0 ? void 0 : _a.cloneNode(true);
    if (!second)
        return;
